...
public enum GenerateDescriptionPrompts {
  GENERATE_DESCRIPTION_TONALITY_SETUP("Act like a senior marketing person for a big ecommerce platform and write a description for a {category} item called {title} and generate pointers for features, benefits in a beneficial tone"),
  ...
  GENERATE_DESCRIPTION_SHORT_LEARNING_INPUT_FOOD("chicken burger"),
  ...
  GENERATE_DESCRIPTION_SHORT_LEARNING_INPUT_FASHION("Louis Philippe Men Pure Cotton Slim Fit Solid Formal Shirt"),
