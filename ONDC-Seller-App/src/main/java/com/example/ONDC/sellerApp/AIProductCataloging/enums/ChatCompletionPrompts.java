...
public enum ChatCompletionPrompts {
  ...
  ENHANCE_TITLE_TONALITY_SETUP("Act like a senior seo analyst and rephrase the product title - %s for my e-commerce product of %s category and  make it appealing to customers by keeping it short and concise"),
  ...
  ENHANCE_DESCRIPTION_TONALITY_SETUP_FOOD("Act like a chef for a 5 star restaurant and rephrase the description - %s for a food item %s"),
  ...
  ENHANCE_DESCRIPTION_TONALITY_SETUP_COMMON("Act like a senior seo analyst and rephrase the product description - %s for my e-commerce product of %s category which is a %s to make it appealing to customers and generate pointers for features, benefits in a positive tone"),
