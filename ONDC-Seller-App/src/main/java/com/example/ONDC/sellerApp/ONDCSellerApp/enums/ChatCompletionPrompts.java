...
//  ENHANCE_DESCRIPTION_SHORT_LEARNING_FOOD_INPUT_V3("Lays 100g"),
  ENHANCE_DESCRIPTION_TONALITY_SETUP_COMMON("act like a senior seo analyst and rephrase the product description , %s for my e-commerce product of %s which is a %s to make it appealing to customers and generate pointers for features, benefits in a beneficial tone"),
...
//  ENHANCE_DESCRIPTION_SHORT_LEARNING_COMMON_INPUT_V2("Carrot 100g"),
//  ENHANCE_DESCRIPTION_SHORT_LEARNING_COMMON_OUTPUT_V2("Fresh & Nutritious: 100g of Crispy Carrots"),
//  ENHANCE_DESCRIPTION_SHORT_LEARNING_COMMON_INPUT_V3("Lays 100g");
